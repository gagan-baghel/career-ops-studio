...
If the posting is closed/expired (404/410, "no longer accepting", redirect to a generic careers page), skip step 2 entirely — write NOTHING — and put CLOSED in place of the score in the final line.

After everything above is written and merged, output EXACTLY one final line, nothing after it:
VERDICT: {score}/5 — {reason in 12 words or fewer}   (dead posting: CLOSED in place of {score}/5)
