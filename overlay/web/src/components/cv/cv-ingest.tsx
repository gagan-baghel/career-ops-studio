...
export function CvIngest({
  ...
  onSaved?: () => void;
  // Handed the original file the moment one is chosen, so a caller can keep it
  // as-is. Parsing reads the file to produce cv.md text and then discards it —
  // the CV that gets attached to an application is a separate artifact.
