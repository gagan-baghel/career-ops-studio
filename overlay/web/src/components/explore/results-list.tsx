...
export function ResultsList({ offers }: { offers: EnrichedOffer[] }) {
  const { companiesScanned, partial, partialSources, addToPipeline, added, mode } = useExplore();
        ...
        <div>
          ...
          <p className="text-[12px] text-faint">
            {isAi
              ...
              : `${companiesScanned > 0 ? `${companiesScanned.toLocaleString()} companies scanned · ` : ""}0 tokens spent${partialNote}`}
          </p>
        </div>
