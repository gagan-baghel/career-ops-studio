...
.co-src__orb{width:.55rem;height:.55rem;border-radius:50%;background:hsl(26 80% 55%)}
...
.co-disc__skelcard::after{content:"";position:absolute;inset:0;background:color-mix(in srgb, var(--fg) 4%, transparent)}
